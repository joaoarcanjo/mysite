            ...
            <div className="space-y-5">
                <div className="flex justify-center">
                    <div className="pt-6 w-3/5">
                        <img className="border-4 border-fifthColor rounded-full" alt="" src={require('./hobbies_photos/gadgets.jpg')}/>
                ...
                <div className="flex justify-center">
                    <div className="pt-6 w-3/5">
                        <img className="border-4 border-fifthColor rounded-full" alt="" src={require('./hobbies_photos/arcanjo_eye.jpg')}/>
                ...
                <div className="flex justify-center">
                    <div className="pt-6 w-3/5">
                        <img className="border-4 border-fifthColor rounded-full" alt="" src={require('./hobbies_photos/bicicleta.jpg')}/>
